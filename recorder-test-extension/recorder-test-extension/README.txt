VIDEO FRAME RECORDER — TEST BUILD, NOT THE FINISHED TOOL
...
- Crops to the visible video image using the player's geometry.
- Refuses to record when actual cropped resolution is 720px high or less.
